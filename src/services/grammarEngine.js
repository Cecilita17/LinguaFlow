...
export const CODE_SWITCHING_LEXICON = {
  ...
  ru: {
    ...
    'pollo': 'курица', 'chicken': 'курица',
    'pescado': 'рыба', 'fish': 'рыба',
    'arroz': 'рис', 'rice': 'рис',
    'queso': 'сыр', 'cheese': 'сыр',
    'huevo': 'яйцо', 'egg': 'яйцо',
    'agua': 'воду', 'water': 'воду',
    'café': 'кофе', 'cafe': 'кофе', 'coffee': 'кофе',
    'té': 'чай', 'tea': 'чай',
    'leche': 'молоко', 'milk': 'молоко',
    'pan': 'хлеб', 'bread': 'хлеб',
    'azúcar': 'сахар', 'sugar': 'сахар',
    'con': 'с', 'with': 'с',
    'sin': 'без', 'without': 'без',
    'para': 'для', 'for': 'для',
    'y': 'и', 'and': 'и',
    'o': 'или', 'or': 'или',
    'pero': 'но', 'but': 'но',
    'porque': 'потому что', 'because': 'потому что',
    'hacer': 'делать', 'make': 'делать',
    'cocinar': 'готовить', 'cook': 'готовить',
    'comer': 'есть', 'eat': 'есть',
    'beber': 'пить', 'tomar': 'пить', 'drink': 'пить',
    'casa': 'дом', 'house': 'дом',
    'amigo': 'друг', 'friend': 'друг',
    'libro': 'книгу', 'book': 'книгу',
    'ciudad': 'город', 'city': 'город',
    'país': 'страна', 'country': 'страна',
    'tiempo': 'время', 'time': 'время',
    'clima': 'погода', 'weather': 'погода',
    'trabajo': 'работа', 'work': 'работать', 'trabajar': 'работать',
    'hoy': 'сегодня', 'today': 'сегодня',
    'mañana': 'завтра', 'tomorrow': 'завтра',
    'ayer': 'вчера', 'yesterday': 'вчера',
    'tonight': 'сегодня вечером',
    'very': 'очень', 'muy': 'очень',
    'tired': 'устал', 'cansado': 'устал', 'cansada': 'устала',
    'good': 'хорошо', 'bueno': 'хорошо', 'bien': 'хорошо',
    'bad': 'плохо', 'malo': 'плохо', 'mal': 'плохо',
    'happy': 'счастлив', 'feliz': 'счастлив',
    'stay': 'остаться', 'quedarme': 'остаться',
    'think': 'думаю', 'pensar': 'думать',
    'quiero': 'хочу', 'want': 'хочу',
    'tengo': 'у меня есть', 'have': 'имею',
    'necesito': 'мне нужно', 'need': 'нужно',
    'gracias': 'спасибо', 'thanks': 'спасибо', 'thank': 'спасибо',
    'por favor': 'пожалуйста', 'please': 'пожалуйста',
    'hola': 'привет', 'hello': 'привет',
    'adiós': 'до свидания', 'adios': 'до свидания', 'bye': 'до свидания'
  },
  tr: {
